...
module.exports = {
    ...
    post: (req, res, next) => {
        const {mobileId, brand, model, modification, engine, power, eurostandart, gearbox, category, price, km, birdayMonth, birdayYear, color, description } = req.body;
        //const { _id } = req.user;

        models.Cars.create({ mobileId, brand, model, modification, engine, power, eurostandart, gearbox, category, price, km, birdayMonth, birdayYear, color, description })
            .then((createdcars) => {
